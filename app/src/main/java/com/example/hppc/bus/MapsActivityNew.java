...
public class MapsActivityNew extends FragmentActivity implements OnMapReadyCallback,
    ...
    LatLng origin1=new LatLng(25.277844,83.002161);
    LatLng mid1=new LatLng(25.302025,82.968397);
    LatLng dest1=new LatLng(25.325087,82.986880);
    LatLng busLoc;

    LatLng origin2=new LatLng(25.277844,83.002161);
    LatLng mid2=new LatLng(25.306840,82.991762);
    LatLng dest2=new LatLng(25.325087,82.986880);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("kkkk", k.substring(k.length() - 4));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(origin1).title("Start Location"));
        mMap.addMarker(new MarkerOptions().position(dest1).title("End Location"));
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(MapsActivityNew.this , "latitude :" + location.getLatitude() + "\n longitude :" + location.getLongitude() , Toast.LENGTH_LONG ).show();
    ...
    public class GetMethodDemo extends AsyncTask<String, Void, String>
    {
        ...
        protected void onPostExecute(String s) {
            ...
            if(flag==1)
            {
                ...
                mMap.addMarker(new MarkerOptions().position(busLoc).title("Your Bus"));
            }
